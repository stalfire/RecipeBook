...
private
	...
	def params_for_recipe
		params.require(:recipe).permit(:title, :description,:category,:user_id, ingredients_attributes: [:id, :name, :amount, :_destroy], instructions_attributes: [:id, :step, :_destroy])
	end
